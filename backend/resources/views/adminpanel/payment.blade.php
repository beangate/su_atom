      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">New Payment</h2>
            <p class="section-lead"> Details</p>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      ...
                      <tr>
                        <td><a href="#" data-toggle="modal" data-target="#myModal">INV-87239</a></td>
                        <td class="font-weight-600">Kusnadi</td>
                        <td class="font-weight-600">Kusnadi</td>
                        <td class="font-weight-600">Kusnadi</td>
                        <td><div class="badge badge-warning">New</div></td>
                        <td>July 19, 2018</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td class="font-weight-600">Muhamad Nuruzzaki</td>
                        <td class="font-weight-600">Muhamad Nuruzzaki</td>
                        <td><div class="badge badge-primary">Shipped</div></td>
                        <td>July 22, 2018</td>
                        <td>
